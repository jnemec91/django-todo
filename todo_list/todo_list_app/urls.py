...
urlpatterns = [
    ...
    path('edit_todo_list/<str:todo_list_hash>/', views.edit_todo_list, name='edit_todo_list'),
    path('delete_todo_list/<str:todo_list_hash>/', views.delete_todo_list, name='delete_todo_list'),
